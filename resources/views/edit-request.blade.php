...
<body>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="student_number" name="student_number" value="{{ $requestData->student_number }}" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="contact" name="contact" value="{{ $requestData->contact }}" required>
    </div>
